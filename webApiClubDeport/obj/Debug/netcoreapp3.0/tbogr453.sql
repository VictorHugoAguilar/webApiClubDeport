...
CREATE TABLE [Pistas] (
    ...
    [Localizacion] nvarchar(max) NOT NULL,
    [DeporteId] int NOT NULL,
    CONSTRAINT [PK_Pistas] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Pistas_Deportes_DeporteId] FOREIGN KEY ([DeporteId]) REFERENCES [Deportes] ([Id]) ON DELETE CASCADE
);
GO
...
VALUES (N'f406bd6e-0de4-4679-874d-33bcb9c6861b', N'1932f13f-abad-4066-a507-488edca40182', N'admin', N'admin');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[AspNetRoles]'))
